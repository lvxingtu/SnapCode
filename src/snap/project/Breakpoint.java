 ...
 * Sets the file.
 */
protected void setFile(WebFile aFile)  { _file = aFile; }

/**
 * Returns the file path.
 */
public String getFilePath()  { return getFile().getPath(); }
 ...
 */
public void setLine(int aLine)  { _line = aLine; }
 ...
 */
public String getDescriptor()  { return getFile().getPath() + " [Line: " + getLineNum() + "]"; }
...
public String toString()
{
    ...
    if(getType()==Type.MethodBreakpoint) {
        ...
        if(_methodArgs!=null) {
            boolean first = true;
            sb.append('(');
            for(String arg : _methodArgs) { if(!first) sb.append(','); first = false; sb.append(arg); }
            sb.append(")");
        }
        return sb.toString();
    }
