 ...
 */
public DebugFrame(DebugThread aDT, StackFrame aFrm, int anIndex)  { _thread = aDT; _frame = aFrm; _index = anIndex; }

/**
 * Returns the DebugThread.
 */
public DebugThread getThread()  { return _thread; }

/**
 * Returns the StackFrame.
 */
public StackFrame getFrame()  { return _frame; }
...
public String getSourcePath()
{
    ...
    catch(Exception e) { System.err.println("DebugFrame.getSourcePath Failed: " + e); return null; }
}
...
public int getLineNumber()
{
    ...
    catch(Exception e) { System.err.println("DebugFrame.getLineNumber Failed: " + e); return -1; }
}
...
{
    DebugFrame other = anObj instanceof DebugFrame? (DebugFrame)anObj : null; if(other==null) return false;
