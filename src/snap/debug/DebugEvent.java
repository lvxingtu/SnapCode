 ...
 */
public ObjectReference getException()  { return ((ExceptionEvent)_jdiEvent).exception(); }
 ...
 */
public Location getCatchLocation()  { return ((ExceptionEvent)_jdiEvent).catchLocation(); }

/**
 * Value that will be assigned to the field when the instruction completes.
 */
public Value getValueToBe()  { return ((ModificationWatchpointEvent)_jdiEvent).valueToBe(); }
 ...
 */
public Location getLocation()  { return ((LocatableEvent)_jdiEvent).location(); }
 ...
 */
public ReferenceType getReferenceType()  { return ((ClassPrepareEvent)_jdiEvent).referenceType(); }

/**
 * Returns the name of the class that has been unloaded.
 */
public String getClassName()  { return ((ClassUnloadEvent)_jdiEvent).className(); }

/**
 * Returns the JNI-style signature of the class that has been unloaded.
 */
public String getClassSignature() { return ((ClassUnloadEvent)_jdiEvent).classSignature(); }

/**
 * Returns the field that is about to be accessed/modified. 
 * @return a {@link Field} which mirrors the field in the target VM.
 */
public Field getField()  { return ((WatchpointEvent)_jdiEvent).field(); }
 ...
 */
public ObjectReference getObject()  { return ((WatchpointEvent)_jdiEvent).object(); }

/**
 * Current value of the field.
 */
public Value getValueCurrent()  { return ((WatchpointEvent)_jdiEvent).valueCurrent(); }
 ...
 */
public int getSuspendPolicy() { return _jdiEvents.suspendPolicy(); }
public boolean suspendedAll() { return _jdiEvents.suspendPolicy()==EventRequest.SUSPEND_ALL; }
public boolean suspendedThread() { return _jdiEvents.suspendPolicy()==EventRequest.SUSPEND_EVENT_THREAD; }
public boolean suspendedNone() { return _jdiEvents.suspendPolicy()==EventRequest.SUSPEND_NONE; }
public void resume() { _jdiEvents.resume(); }
