 ...
 */
public DebugThread(DebugApp aDApp, ThreadReference aTRef)  { _app = aDApp; _tref = aTRef; }
...
public String getName()
{
    ...
    try { return _name = _tref.name(); }
    catch(Exception e) { System.err.println("DebugThread.getName: " + e); return _name = "Error"; }
}
...
{
    try { return _tref.isSuspended(); }
    catch(Exception e) { System.err.println("DebugThread.isSuspended: " + e); return false; }
}
...
public DebugFrame[] getFrames()
{
    ...
    catch(Exception e) { return NO_FRAMES; }
}
...
{
    DebugThread other = anObj instanceof DebugThread? (DebugThread)anObj : null; if(other==null) return false;
