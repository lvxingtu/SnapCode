 ...
 */
public WebFile getBuildDir()  { return _proj.getBuildDir(); }
...
protected void initUI()
{
    ...
    _pageBrowser.setName("PageBrowser"); _pageBrowser.setGrowHeight(true);
...
private class FileResolver extends TreeResolver <WebFile> {
    ...
    public WebFile[] getChildren(WebFile aPar)  { return aPar.getFiles().toArray(new WebFile[0]); }
