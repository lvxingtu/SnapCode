 ...
 */
public void addVarDecl(JVarDecl aVD)  { _vars.add(aVD); addChild(aVD, -1); }

/**
 * Override to return first var decl.
 */
@Override
protected JavaDecl getDeclImpl()  { return _vars.size()>0? _vars.get(0).getDecl() : null; }

/**
 * Returns the part name.
 */
public String getNodeString()  { return "FieldDecl"; }
