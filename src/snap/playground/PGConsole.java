 ...
 */
public class PGConsole extends ViewOwner {

    // The Playground
    Playground           _pg;

    // The output text
    PGConsoleView        _tview;
 ...
 */
public PGConsole(Playground aPG)  { _pg = aPG; }
 ...
 */
public ConsoleView getConsoleView()  { return _tview; }
...
protected void initUI()
{
    ...
    _tview.setFont(defaultFont); _tview.setPlainText(false); _tview.setPadding(4,4,4,4);
}
 ...
 */
public static class PGConsoleView extends ConsoleView {
