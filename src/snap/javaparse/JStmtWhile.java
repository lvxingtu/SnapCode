 ...
 */
public void setConditional(JExpr aCond)  { replaceChild(_cond, _cond = aCond); }
...
public JStmtBlock getBlock()
{
    ...
    JStmtBlock sb = new JStmtBlock(); if(_stmt!=null) sb.addStatement(_stmt); setStmt(sb);
    return sb;
}
 ...
 * Sets a block.
 */
public void setBlock(JStmtBlock aBlock)  { setStmt(aBlock); }
