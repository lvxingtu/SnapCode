 ...
 */
public JExprArrayIndex(JExpr anArrayExpr, JExpr anIndexExpr)  { setIndexExpr(anIndexExpr); }
 ...
 * Sets the index expression.
 */
public void setIndexExpr(JExpr anExpr)  { replaceChild(_indexExpr, _indexExpr=anExpr); }
...
protected JavaDecl getDeclImpl()
{
    ...
    Class iclass = pclass!=null && pclass.isArray()? pclass.getComponentType() : null;
    return iclass!=null? new JavaDecl(iclass) : JavaDecl.OBJECT_DECL;
}
