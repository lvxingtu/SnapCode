 ...
 */
public void setInitDecl(JStmtVarDecl aVD)  { replaceChild(_initDecl, _initDecl=aVD); }
 ...
 */
public void setConditional(JExpr anExpr)  { replaceChild(_cond, _cond=anExpr); }
 ...
 */
public void addUpdateStmt(JStmtExpr aStmtExpr)  { _updateStmts.add(aStmtExpr); addChild(aStmtExpr, -1); }
 ...
 */
public void addInitStmt(JStmtExpr aStmtExpr)  { _initStmts.add(aStmtExpr); addChild(aStmtExpr, -1); }
 ...
 * Sets the statement.
 */
public void setStatement(JStmt aStmt)  { replaceChild(_stmt, _stmt=aStmt); }
 ...
 * Sets a block.
 */
public void setBlock(JStmtBlock aBlock)  { setStatement(aBlock); }
