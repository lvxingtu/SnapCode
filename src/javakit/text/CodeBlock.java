...
public class CodeBlock {
     ...
     */
    public CodeBlock init(JNode aNode, Method aMethod)  { _node = aNode; _method = aMethod; return this; }
     ...
     * Returns the string for CodeBlock.
     */
    protected String createString()  { return getMethodString(_method); }
     ...
     */
    public String getReplaceString()  { return getReplaceMethodString(_method); }
    ...
    {
        StringBuffer sb = new StringBuffer(aMethod.getName()).append('(');
        Class classes[] = aMethod.getParameterTypes(); String argSep = "";
        for(Class c : classes) {
            String string = "null";
            ...
            sb.append(argSep).append(string); argSep = ", ";
        }
        String string = sb.append(");").toString();
        if(_node instanceof JExprId) { JExprId id = (JExprId)_node;
            if(id.isVarId()) string = id.getName() + "." + string; }
